...
export const LUXURY_FEATURES: LuxuryFeature[] = [
  ...
  },
  {
    ...
    description: "Established in 1957, Prashant Jewellers is built upon a foundation of trust, transparent rates, and Rajasthani hospitality.",
    iconName: "Award"
  },
  {
    id: "feat-3",
...
export const PRODUCTS: Product[] = [
  // Bridal Collection
  {
    ...
    image: '/KundanMahalEmperorChoker.jpg',
    rating: 5,
    isFeatured: true,
