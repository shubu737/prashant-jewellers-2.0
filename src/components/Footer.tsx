...
export default function Footer({ onNavigate }: FooterProps) {
  ...
  return (
    <footer id="footer" className="relative overflow-hidden bg-[#050505] text-[#F5F5F5] border-t border-[#D4AF37]/15">
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-12 items-start pb-12 border-b border-zinc-900">
          ...
          <div className="md:col-span-4 space-y-6">
            ...
            <p className="font-serif text-xs italic leading-relaxed text-zinc-400 max-w-sm">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-[10px] tracking-widest uppercase text-zinc-400 font-sans">Boutiques Open • Custom Consultations Active</span>
            </div>
          </div>
              ...
              {[
                ...
                <li key={link.id}>
                  <button
                    ...
                    className="font-sans text-xs text-zinc-400 hover:text-[#D4AF37] hover:pl-1 transition-all duration-300 cursor-pointer text-left"
                  >
                    • {link.label}
                  </button>
                </li>
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between text-[11px] text-zinc-500 font-sans gap-4">
          <div className="flex flex-wrap items-center justify-center gap-4">
            <div className="flex items-center space-x-1.5 border border-zinc-800 bg-neutral-950 px-3 py-1 rounded-sm">
              <ShieldCheck className="h-3.5 w-3.5 text-[#D4AF37]" />
              <span className="text-[10px] tracking-wide text-zinc-400">100% BIS Hallmarked Purity Guaranteed</span>
            </div>
          </div>

          <div className="text-center md:text-right">
            <p>© {new Date().getFullYear()} Prashant Jewellers. All rights reserved.</p>
            <p className="text-[10px] text-zinc-650 mt-1 flex items-center justify-center md:justify-end">
