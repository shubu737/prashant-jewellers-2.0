...
export default function Footer({ onNavigate }: FooterProps) {
  ...
  return (
    <footer id="footer" className="relative overflow-hidden bg-[#FAF8F5] text-[#1A1A1A] border-t border-[#D4AF37]/15">
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-12 items-start pb-12 border-b border-[#D4AF37]/10">
          ...
          <div className="md:col-span-4 space-y-6">
            <div className="flex items-center space-x-3 cursor-pointer" onClick={() => handleLinkClick('home')}>
              ...
              <div className="flex flex-col">
                <span className="font-serif text-xl font-bold tracking-widest uppercase text-[#1A1A1A]">
                  Prashant
                </span>
            ...
            <p className="font-serif text-xs italic leading-relaxed text-[#4A4A4A] max-w-sm">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-[10px] tracking-widest uppercase text-[#4A4A4A] font-sans">Boutiques Open • Custom Consultations Active</span>
            </div>
          </div>
              ...
              {[
                ...
                <li key={link.id}>
                  <button
                    ...
                    className="font-sans text-xs text-[#4A4A4A] hover:text-[#D4AF37] hover:pl-1 transition-all duration-300 cursor-pointer text-left"
                  >
                    • {link.label}
                  </button>
                </li>
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <div className="space-y-3 font-sans text-xs text-[#4A4A4A] leading-relaxed">
        ...
        {/* Bottom Rights Bar */}
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between text-[11px] text-[#4A4A4A] font-sans gap-4">
          <div className="flex flex-wrap items-center justify-center gap-4">
            <div className="flex items-center space-x-1.5 border border-[#D4AF37]/10 bg-[#F0EDE8] px-3 py-1 rounded-sm">
              <ShieldCheck className="h-3.5 w-3.5 text-[#D4AF37]" />
              <span className="text-[10px] tracking-wide text-[#4A4A4A]">100% BIS Hallmarked Purity Guaranteed</span>
            </div>
          </div>

          <div className="text-center md:text-right">
            <p>© {new Date().getFullYear()} Prashant Jewellers. All rights reserved.</p>
            <p className="text-[10px] text-[#4A4A4A] mt-1 flex items-center justify-center md:justify-end">
