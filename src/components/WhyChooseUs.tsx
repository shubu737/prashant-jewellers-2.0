      ...
      <div className="mx-auto max-w-7xl">
          ...
          {LUXURY_FEATURES.map((feature, idx) => {
            ...
            return (
              <motion.div
                ...
                key={feature.id}
                className="group relative border border-zinc-900 bg-[#080808] p-8 transition-all duration-500 hover:border-[#D4AF37]/30 hover:bg-black/40 hover:shadow-[0_10px_30px_rgba(212,175,55,0.03)]"
              >
                ...
                <div className="mb-6 inline-flex h-12 w-12 items-center justify-center rounded-none border border-zinc-800 bg-neutral-950 text-[#D4AF37] group-hover:border-[#D4AF37]/40 group-hover:text-amber-300 transition-all duration-500">
                  <IconComponent className="h-5 w-5" />
                </div>

                <h3 className="font-serif text-lg tracking-wide text-white group-hover:text-amber-300 transition-colors duration-300">
                  {feature.title}
                </h3>

                <p className="mt-3.5 font-sans text-xs leading-relaxed text-zinc-400 group-hover:text-zinc-300 transition-colors duration-300">
                  {feature.description}
                </p>
        ...
        <div className="mt-20 border-t border-zinc-900 pt-12 text-center">
          <div className="inline-flex flex-wrap items-center justify-center gap-10 opacity-65 grayscale hover:grayscale-0 transition-all duration-500">
            <span className="font-serif text-sm tracking-widest text-zinc-500 font-semibold">BIS 916 CERTIFIED</span>
            <span className="h-1.5 w-1.5 rounded-full bg-zinc-700" />
            <span className="font-serif text-sm tracking-widest text-zinc-500 font-semibold">IGI DIAMOND LABS</span>
            <span className="h-1.5 w-1.5 rounded-full bg-zinc-700" />
            <span className="font-serif text-sm tracking-widest text-zinc-500 font-semibold">GIA ACCREDITED</span>
            <span className="h-1.5 w-1.5 rounded-full bg-zinc-700" />
            <span className="font-serif text-sm tracking-widest text-zinc-500 font-semibold">RASTHA ADVISORY</span>
          </div>
        </div>
