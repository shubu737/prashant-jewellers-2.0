      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-center">
            ...
            <div className="md:col-span-5 relative overflow-hidden aspect-square border border-[#D4AF37]/10 bg-white/90 rounded-sm">
              <img
                src={product.image}
                alt={product.name}
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-baseline space-x-4">
                  ...
                  {product.originalPrice && (
                    <span className="font-sans text-xs text-[#6b7280] line-through">
