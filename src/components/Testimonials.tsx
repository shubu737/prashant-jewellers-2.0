  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="relative border border-[#D4AF37]/10 bg-[#F0EDE8] p-8 md:p-16 transition-all duration-500">
          ...
          <div className="relative z-10 flex flex-col items-center text-center space-y-8">
            ...
            <AnimatePresence mode="wait">
              <motion.p
                ...
                className="font-serif text-base sm:text-xl md:text-2xl italic leading-relaxed text-[#4A4A4A]"
              >
                "{current.text}"
              </motion.p>
            </AnimatePresence>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="text-left">
                  <div className="font-serif text-sm font-semibold tracking-wide text-[#1A1A1A]">{current.name}</div>
          ...
          <div className="absolute bottom-6 right-6 flex items-center space-x-3 z-20">
            <button
              onClick={handlePrev}
              className="flex h-10 w-10 items-center justify-center border border-[#D4AF37]/10 bg-white/90 text-[#1A1A1A] hover:border-[#D4AF37] hover:text-[#D4AF37] transition-all duration-300 cursor-pointer"
